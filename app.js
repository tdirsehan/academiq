...
function buildInquiry(){
  ...
  const message=`AcademIQ Tools Institutional Pilot Enquiry\n\nInstitution: ${institution}\nUnit / role: ${role}\nExpected user group: ${size}\nModules of interest: ${moduleText}\nPilot preference: 30-day institutional evaluation\n${note?`Additional note: ${note}\n`:''}\nWe would like to discuss a limited institutional pilot of AcademIQ Tools and, if appropriate, a tailored annual institutional licence.`;
